...
public static class WordJumpService
{
    ...
    {
        // Use a temporary range over the whole document so Find doesn't alter the
        // persistent selection if nothing is found.
        var doc = app.ActiveDocument;
    ...
    {
        // block_index is 0-based; Word paragraphs collection is 1-based.
